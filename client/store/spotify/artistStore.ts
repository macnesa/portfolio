  ...
  fetch: async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/spotify/artists/getArtist/${id}`,
        {
          method: "GET",
          credentials: "include",
        }
...
export const useArtistTopTracksStore = create< State<ArtistTopTracks['data']> >((set, get) => ({
  ...
  fetch: async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/spotify/artists/getTopTracks/${id}`,
        {
          method: "GET",
          credentials: "include",
        }
...
export const useArtistAlbumsStore = create< State<ArtistAlbums['data']> >((set, get) => ({
  ...
  fetch: async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/spotify/artists/getAlbums/${id}`,
        {
          method: "GET",
          credentials: "include",
        }
